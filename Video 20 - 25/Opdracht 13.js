...
if (hoogsteCijferSarah > hoogsteCijferSofie) {
  console.log(
    "Het hoogste cijfer is behaald door Sarah en het cijfer is " +
      hoogsteCijferSarah
  );
} else if (hoogsteCijferSofie > hoogsteCijferSarah) {
  console.log(
    "Het hoogste cijfer is behaald door Sofie en het cijfer is " +
      hoogsteCijferSofie
  );
}
